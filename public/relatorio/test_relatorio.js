...
describe('Validação do Formulário de Relatório', () => {
    let dom;
    let document;
    let form;
    let fields;
...
<body>
    ...
    <script src="relatorio.js"></script>
        ...
        fields = {
            ...
            nomeOrientador: document.getElementById('nomeOrientador'),
            numeroUSP: document.getElementById('numeroUSP'),
            linkLattes: document.getElementById('linkLattes'),
            dataAtualizacaoLattes: document.getElementById('dataAtualizacaoLattes'),
            curso: document.getElementById('curso'),
            dataIngresso: document.getElementById('dataIngresso'),
            resultadoUltimoRelatorio: document.querySelector('input[name="resultadoUltimoRelatorio"]:checked'),
            aprovacoesDisciplinas: document.querySelector('input[name="aprovacoesDisciplinas"]:checked'),
            reprovacoesDisciplinas: document.querySelector('input[name="reprovacoesDisciplinas"]:checked'),
            reprovacoesInicio: document.querySelector('input[name="reprovacoesInicio"]:checked'),
            exameProficiencia: document.querySelector('input[name="exameProficiencia"]:checked'),
            exameQualificacao: document.querySelector('input[name="exameQualificacao"]:checked'),
            prazoDissertacao: document.getElementById('prazoDissertacao'),
            artigosEscrita: document.querySelector('input[name="artigosEscrita"]:checked'),
            artigosEmAvaliacao: document.querySelector('input[name="artigosEmAvaliacao"]:checked'),
            artigosAceitos: document.querySelector('input[name="artigosAceitos"]:checked'),
            atividadesEventos: document.getElementById('atividadesEventos'),
            resumoAtividades: document.getElementById('resumoAtividades'),
            dificuldades: document.querySelector('input[name="dificuldades"]:checked')
        };
    });
    ...
    it('deve habilitar o botão de envio quando todos os campos obrigatórios estiverem preenchidos', () => {
        ...
        document.getElementById('nomeOrientador').value = 'André Carlos Busanelli de Aquino';
        document.getElementById('aprovado').checked = true;
        document.getElementById('aprovacoes1').checked = true;
        document.getElementById('reprovacoes0').checked = true;
        document.getElementById('reprovacoesInicio0').checked = true;
        document.getElementById('profAprovado').checked = true;
        document.getElementById('qualAprovado').checked = true;
        document.getElementById('prazoDissertacao').value = 'janeiro/2025';
        document.getElementById('artigosEscrita1').checked = true;
        document.getElementById('artigosEmAvaliacao1').checked = true;
        document.getElementById('artigosAceitos1').checked = true;
        document.getElementById('atividadesEventos').value = 'Participação em congresso';
        document.getElementById('resumoAtividades').value = 'Resumo das atividades de pesquisa';
        document.getElementById('dificuldadesNao').checked = true;
    ...
    it('deve mostrar mensagem de erro para URL inválida no Link para o Lattes', () => {
        ...
        expect(fields.linkLattes.validationMessage).to.not.be.empty;
    });
    ...
    it('não deve mostrar mensagem de erro para URL válida no Link para o Lattes', () => {
        ...
        expect(fields.linkLattes.validationMessage).to.be.empty;
    });
});